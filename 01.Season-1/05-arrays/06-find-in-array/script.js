...
let resultat=people.find( person => person.lastname === 'Dupont');
let pos=people.findIndex(person => person.lastname ==='Dupont');
console.log("email: "+resultat['email']+" index: "+(pos));
